<?php
  ...
  $projectData = selectedProject($_GET['id'], $dbh);
    ...
    <div class="col-md-8">
      <div class="panel panel-default">
        <div class="panel-heading">
          <img src="<?= $projectData['image_url'] ?>" class="img-responsive" alt="">
        </div>
        <div class="panel-body">
          ...
          <div class="pull-right">
            <p><a href="<?= $projectData['link'] ?>"><?= $projectData['link'] ?></a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="panel-body">
              ...
              <li class="media">
                <div class="media-left">
                  <img class="comments-profile-photo" src="https://www.gravatar.com/avatar/6d0570bfa2188276d3258b4561f8aae9?s=80&d=mm&r=g">
                </div>
                <div class="media-body">
                  <div class="form-group" style="padding:12px;">
                    <form method="POST" action="view.php?id=22">
